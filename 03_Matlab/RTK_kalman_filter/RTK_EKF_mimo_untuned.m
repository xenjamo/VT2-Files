...
% figure(3003) subplot(411) plot(t, mag_calib); grid on; subplot(412) plot(t,
...
saveForLatex1d([y(:,1),x_hat(:,1)],t,'nhat_no_tuning.csv',1.2);
saveForLatex1d([y(:,2),x_hat(:,2)],t,'what_no_tuning.csv',1.2);
saveForLatex1d([y(:,3),x_hat(:,3)],t,'uhat_no_tuning.csv',1.2);
...
saveForLatex1d([y(:,4),x_hat(:,4)],t,'vnhat_no_tuning.csv',1.2);
saveForLatex1d([y(:,5),x_hat(:,5)],t,'vwhat_no_tuning.csv',1.2);
saveForLatex1d([y(:,6),x_hat(:,6)],t,'vuhat_no_tuning.csv',1.2);
